...
@section('dashboard')
					<div class="col-12">
						...
						<a class="option col-12 " href="user"><i class="fas fa-truck-moving"></i> Đơn hàng của bạn</a>
						<a class="option col-12 active" href="user/cap-nhat-tai-khoan"><i class="fas fa-tachometer-alt"></i> Cập nhật tài khoản</a>
						<a class="option col-12 " href="user/bao-mat"><i class="fas fa-shield-alt"></i> Bảo mật</a>
						<a class="option col-12 " href="logout"><i class="fas fa-sign-out-alt"></i> Đăng Xuất</a>
						</div>
		@endsection
		
@section('display')
	<a class="close" href="javascript:void(0)" onclick="openMenu()"><i class="fas fa-bars" style="font-size:36px;"></i></a>
