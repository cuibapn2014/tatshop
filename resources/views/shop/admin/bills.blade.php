...
<div class="col-12 w-100 p-0 text-center d-inline-flex">
    <p class="col-3 mr-2 bg-warning p-3 text-white float-left font-weight-light" style="font-size:36px;"><i
            class="bi bi-clipboard"></i> {{count($confirm)}}</p>
    <p class="col-3 mr-2 bg-success p-3 text-white float-left font-weight-light" style="font-size:36px;"><i
            class="bi bi-truck"></i> {{count($transfering)}}</p>
    <p class="col-3 mr-2 bg-info p-3 text-white float-left font-weight-light" style="font-size:36px;"><i
            class="bi bi-check-circle"></i> {{count($recieved)}}</p>
</div>
@if(session('notice'))
...
<div class="col-lg-3 col-md-6 col-sm-12 border p-2 d-inline-block m-1" style="height:auto">
    <div class="col-12">
        ...
        <p class="mb-1"><i class="fas fa-ticket-alt text-danger"></i> {{$bill->discount}}% ~
            {{number_format(($bill->total / (1 - $bill->discount/100)) * ($bill->discount/100))}}đ</p>
